...
{
    /// <inheritdoc />
    public partial class OrderModuleTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortName = table.Column<string>(type: "varchar(200)", nullable: false),
                    Description = table.Column<string>(type: "varchar(500)", nullable: false),
                    DeliveryTime = table.Column<string>(type: "varchar(200)", nullable: false),
